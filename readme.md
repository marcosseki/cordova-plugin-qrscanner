# What's changed for Univision?
We use the `cordova-plugin-camera-preview` with this plugin, and we have a problem with duplicated camera permission on Android build. We remove the permission of this plugin.
